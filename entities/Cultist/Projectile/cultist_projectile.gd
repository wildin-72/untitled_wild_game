...
@export var distance_from_player_x : int = 600
@export var distance_from_player_y : int = 100
...
func _on_charge_attack():
	state_machine.on_state_transition(state_machine.current_state, "Fireball")
